...
Crop.prototype.save = function () {
    ...
    function performImageAdjustments() {
        try {
            //todo cropping with flipping calculations
            var sx = that.cnv.toSave.x, //The x coordinate where to start clipping
                sy = that.cnv.toSave.y, //The y coordinate where to start clipping
                swidth = that.cnv.toSave.w, //The width of the clipped image
                sheight = that.cnv.toSave.h, //The height of the clipped image
                ...
                width = that.cnv.toSave.w, //The width of the image to use (stretch or reduce the image)
