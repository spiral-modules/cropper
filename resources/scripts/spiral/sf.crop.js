...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"sf-crop-modal modal crop\"><div class=modal-header><button class=\"close sf-crop-close\">×</button><div class=cropper-info><div class=sf-crop-ratio></div><div class=sf-crop-orig-size></div><div class=sf-crop-cropped-size></div></div></div><div class=modal-body><div class=crop-info><span class=crop-ratio></span></div><div class=crop-container><div class=sf-crop-image-original></div><div class=\"sf-crop-wrapper crop-wrapper\"><div class=dimmers-container><div class=dimmers><div class=\"dimmer dimmer-N\"></div><div class=\"dimmer dimmer-E\"></div><div class=\"dimmer dimmer-S\"></div><div class=\"dimmer dimmer-W\"></div></div></div><div class=\"sf-crop-elements crop-elements\"><div class=\"handler handler-N\"></div><div class=\"handler handler-NE\"></div><div class=\"handler handler-E\"></div><div class=\"handler handler-SE\"></div><div class=\"handler handler-S\"></div><div class=\"handler handler-SW\"></div><div class=\"handler handler-W\"></div><div class=\"handler handler-NW\"></div></div></div></div></div><div class=modal-footer><br><button type=button class=\"sf-crop-save btn-save\">Save changes</button></div></div>";
